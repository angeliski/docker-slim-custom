...
RUN apt-get update && apt-get upgrade -y && apt-get -y install apache2 php5 php5-cli php5-mysqlnd curl vim supervisor  mysql-client php5-mysql libapache2-mod-auth-mysql
